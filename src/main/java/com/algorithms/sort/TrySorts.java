...
public class TrySorts extends Applet implements MouseListener, WindowListener {
    ...
    class IvjEventHandler implements ActionListener, TextListener {
  ...
  /* WARNING: THIS METHOD WILL BE REGENERATED. */
     ...
     */
    private Label getArraySortLabel() {
        if (ivjArraySortLabel == null) {
            try {
                ivjArraySortLabel = new Label();
     ...
     */
    private Checkbox getBubbleSortBox() {
        if (ivjBubbleSortBox == null) {
            try {
                ivjBubbleSortBox = new Checkbox();
    ...
    private Checkbox getMergesortBox() {
        if (ivjMergeSortBox == null) {
            try {
                ivjMergeSortBox = new Checkbox();
     ...
     */
    private Button getClearOutputButton() {
        if (ivjClearOutputButton == null) {
            try {
                ivjClearOutputButton = new Button();
     ...
     * @return java.awt.Checkbox
     */
    private Checkbox getHeapSortBox() {
        if (ivjHeapSortBox == null) {
            try {
                ivjHeapSortBox = new Checkbox();
     ...
     */
    private TextField getMaxElementField() {
        if (ivjMaxElementField == null) {
            try {
                ivjMaxElementField = new TextField();
     ...
     * @return java.awt.Label
     */
    private Label getMaxElementLabel() {
        if (ivjMaxElementLabel == null) {
            try {
                ivjMaxElementLabel = new Label();
     ...
     * @return java.awt.TextField
     */
    private TextField getNumItemsField() {
        if (ivjNumItemsField == null) {
            try {
                ivjNumItemsField = new TextField();
     ...
     * @return java.awt.Label
     */
    private Label getNumItemsLabel() {
        if (ivjNumItemsLabel == null) {
            try {
                ivjNumItemsLabel = new Label();
     ...
     * @return java.awt.Checkbox
     */
    private Checkbox getQuickSortBox() {
        if (ivjQuickSortBox == null) {
            try {
                ivjQuickSortBox = new Checkbox();
     ...
     * @return java.awt.Checkbox
     */
    private Checkbox getShowOutputBox() {
        if (ivjShowOutputBox == null) {
            try {
                ivjShowOutputBox = new Checkbox();
     ...
     */
    private CheckboxGroup getSortTypeGroup() {
        if (ivjSortTypeGroup == null) {
            try {
                ivjSortTypeGroup = new CheckboxGroup();
            } catch (Throwable ivjExc) {
                handleException(ivjExc);
            }
        }
     ...
     * @return java.awt.TextField
     */
    private TextField getTimeTakenField() {
        if (ivjTimeTakenField == null) {
            try {
                ivjTimeTakenField = new TextField();
     ...
     * @return java.awt.Label
     */
    private Label getTimeTakenLabel() {
        if (ivjTimeTakenLabel == null) {
            try {
                ivjTimeTakenLabel = new Label();
